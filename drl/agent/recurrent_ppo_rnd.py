...
class RecurrentPPORND(Agent):
    ...
    def _train(self):
        ...
        advantage, ext_target_state_value, int_target_state_value, metric_info_dicts = self._compute_adv_target(exp_batch)
    ...
    def _compute_adv_target(self, exp_batch: RecurrentPPORNDExperience):
        ...
        int_advantage = L.gae(
            ...
            int_reward,
            torch.zeros_like(terminated) if not self._config.episodic else terminated, # non-episodic
        ...
        return advantage, ext_target_state_value, int_target_state_value, metric_info_dicts
